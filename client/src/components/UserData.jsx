  ...
  return (
    <div id='UserDataContainer'>
      <div id='DataFormMessage'>
        <div id='DataFormWelcome'>Welcome to the Starlink Satellite Tracker</div>
        <div id='about'>This Webapp will grab your current location, and show you the closest Starlink satellite to your location currently.</div>
        <div id='prompt'>Enter your new Username below and click on the satellite to find the nearest Starlink Satellite</div>
        </div>
    <form onSubmit={handleSubmit} id='DataFormContainer'>
        <input id='UserDataForm'
